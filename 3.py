...
def encrypt():
    plaintext_ascii = plaintext_entry.get()
    plaintext = string_to_binary(plaintext_ascii)
    key = key_entry.get()
    ...
    encrypted_ascii = binary_to_string(encrypted)
    result_var.set(encrypted_ascii)
...
def decrypt():
    ciphertext_ascii = ciphertext_entry.get()
    ciphertext = string_to_binary(ciphertext_ascii)
    key = key_entry.get()
    ...
    decrypted_ascii = binary_to_string(decrypted)
    result_var.set(decrypted_ascii)
